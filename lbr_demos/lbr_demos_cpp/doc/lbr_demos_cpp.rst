...
#. Run the `joint_sine_overlay <https://github.com/lbr-stack/lbr_fri_ros2_stack/blob/rolling/lbr_demos/lbr_demos_cpp/src/joint_sine_overlay.cpp>`_:octicon:`link-external` node:
...
#. Run the `joint_trajectory_client <https://github.com/lbr-stack/lbr_fri_ros2_stack/blob/rolling/lbr_demos/lbr_demos_cpp/src/joint_trajectory_client.cpp>`_:octicon:`link-external`:
...
#. Client side configurations:
    ...
    #. Configure the ``client_command_mode`` to ``torque`` in `lbr_system_config.yaml <https://github.com/lbr-stack/lbr_fri_ros2_stack/blob/rolling/lbr_ros2_control/config/lbr_system_config.yaml>`_:octicon:`link-external`
    #. Set the ``update_rate`` to ``500`` in `hardware.yaml <https://github.com/lbr-stack/lbr_fri_ros2_stack/blob/rolling/lbr_ros2_control/config/controllers/hardware.yaml>`_:octicon:`link-external`
...
#. Run the `torque_sine_overlay <https://github.com/lbr-stack/lbr_fri_ros2_stack/blob/rolling/lbr_demos/lbr_demos_cpp/src/torque_sine_overlay.cpp>`_:octicon:`link-external` node:
...
#. Client side configurations:
    ...
    #. Configure the ``client_command_mode`` to ``wrench`` in `lbr_system_config.yaml <https://github.com/lbr-stack/lbr_fri_ros2_stack/blob/rolling/lbr_ros2_control/config/lbr_system_config.yaml>`_:octicon:`link-external`
    #. Set the ``update_rate`` to ``500`` in `hardware.yaml <https://github.com/lbr-stack/lbr_fri_ros2_stack/blob/rolling/lbr_ros2_control/config/controllers/hardware.yaml>`_:octicon:`link-external`
...
#. Run the `wrench_sine_overlay <https://github.com/lbr-stack/lbr_fri_ros2_stack/blob/rolling/lbr_demos/lbr_demos_cpp/src/wrench_sine_overlay.cpp>`_:octicon:`link-external` node:
