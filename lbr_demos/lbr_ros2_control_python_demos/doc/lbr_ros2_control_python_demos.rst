...
2. Run the `lbr_joint_trajectory_executioner_node <https://github.com/KCL-BMEIS/lbr_fri_ros2_stack/blob/galactic/lbr_demos/lbr_ros2_control_python_demos/lbr_ros2_control_python_demos/lbr_joint_trajectory_executioner_node.py>`_:
