...
2. Run the `lbr_joint_trajectory_executioner_node <https://github.com/KCL-BMEIS/lbr_fri_ros2_stack/blob/foxy/lbr_demos/lbr_ros2_control_cpp_demos/src/lbr_joint_trajectory_executioner_node.cpp>`_:
