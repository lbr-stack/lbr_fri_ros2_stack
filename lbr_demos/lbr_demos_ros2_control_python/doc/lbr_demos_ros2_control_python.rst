...
#. Run the `lbr_joint_trajectory_executioner_node <https://github.com/lbr-stack/lbr_fri_ros2_stack/blob/rolling/lbr_demos/lbr_demos_ros2_control_python/lbr_demos_ros2_control_python/lbr_joint_trajectory_executioner_node.py>`_:
