...
2. Run the `admittance_control_node <https://github.com/KCL-BMEIS/lbr_fri_ros2_stack/blob/rolling/lbr_demos/lbr_fri_ros2_advanced_cpp_demos/src/admittance_control_node.cpp>`_:
