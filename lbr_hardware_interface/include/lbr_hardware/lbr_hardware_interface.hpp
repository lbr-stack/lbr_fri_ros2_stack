...
#include <lbr_hardware/lbr_hardware_interface_type_values.hpp>
...
namespace lbr_hardware
{
    ...
    class LBRHardwareInterface : public hardware_interface::SystemInterface, public KUKA::FRI::LBRClient
    {

    public:
        LBRHardwareInterface() : app_(connection_, *this){};
    ...
    private:
        const std::string FRI_HW_LOGGER = "LBRHardwareInterface";
...
} // end of name space lbr_hardware
