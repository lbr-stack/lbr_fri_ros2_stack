...
- Parameters, such as ``update_rate``, the configured controllers, are simply set as node parameters, see e.g. `hardware.yaml <https://github.com/lbr-stack/lbr_fri_ros2_stack/blob/jazzy/lbr_ros2_control/config/controllers/hardware.yaml>`_:octicon:`link-external`.
...
- FRI relevant parameters are forwarded to the ``lbr_ros2_control::SystemInterface`` plugin from `lbr_system_config.yaml <https://github.com/lbr-stack/lbr_fri_ros2_stack/blob/jazzy/lbr_ros2_control/config/lbr_system_config.yaml>`_:octicon:`link-external`
