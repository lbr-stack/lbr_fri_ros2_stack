...
class LIN {
public:
	LIN(const double* x_start, const double* x_end, const double* q_init, const int n_joints, const int status, const int turn, const double a = 40./*mm/s^2*/, const double vmax = 80. /*mm/s*/, const double dt = 0.005) : n_joints_(n_joints), status_(status), turn_(turn), dt_(dt) {
