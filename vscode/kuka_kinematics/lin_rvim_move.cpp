...
point_cloud merry_christmas = { // in x-y-z plane
	...
	{0.0, -59.0, 0.0},   // 12
	{19.0, -59.0, 0.0},  // 13
	{19.0, -59.0, 10.0}, // transition
	{11.0, -59.0, 10.0}, // transition
	{11.0, -59.0, 0.0},  // 14
	{19.0, -66.0, 0.0},  // 15
	{19.0, -72.0, 0.0},  // 16
	...
	{0.0, -79.0, 0.0},   // 17
	{19.0, -79.0, 0.0},  // 18
	{19.0, -79.0, 10.0}, // transition
	{11.0, -79.0, 10.0}, // transition
	{11.0, -79.0, 0.0},  // 19
	{19.0, -86.0, 0.0},  // 20
	{19.0, -92.0, 0.0},  // 21
	...
	{0.0, -99.0, 0.0},     // 23
	{0.0, -113.0, 0.0},    // 24
	{0.0, -113.0, 10.0},   // transition
	{19.0, -113.0, 10.0},  // transition
	{19.0, -113.0, 0.0},   // 25
	{- 11.0, -113.0, 0.0}, // 26
	{- 11.0, -99.0, 0.0},  // 27
	...
	{- 23.5, -44.5, 0.0}, // 32
	{- 54.0, -44.5, 0.0}, // 33
	{-54.0, -44.5, 10.0}, // transition 
	{-35.0, -44.5, 10.0}, // transition 
	{- 35.0, -44.5, 0.0}, // 34 
	{- 35.0, -58.0, 0.0}, // 35
	{- 54.0, -58.0, 0.0}, // 36
	...
	{- 54.0, -64.5, 0.0}, // 37
	{- 35.0, -64.5, 0.0}, // 38
	{-35.0, -64.5, 10.0},  // transition
	{-43.0, -64.5, 10.0},  // transition
	{- 43.0, -64.5, 0.0}, // 39
	{- 35.0, -71.5, 0.0}, // 40
	{- 35.0, -77.5, 0.0}, // 41
	...
	{-23.5, -84.5, 0.0},   // 42
	{- 25.5, -84.5, 0.0},  // 43
	{ -25.5, -84.5, 10.0 }, // transition
	{ -35.0, -84.5, 10.0 }, // transition
	{- 35.0, -84.5, 0.0},  // 44
	{- 54.0, -84.5, 0.0},  // 45
	...
	{- 54.0, -111.0, 0.0}, // 53
	{- 54.0, -125.0, 0.0}, // 54
	{ -54.0, -125.0, 10.0 }, // transition
	{ -35.0, -111.0, 10.0 }, // transition
	{- 35.0, -111.0, 0.0}, // 55
	{- 35.0, -118.0, 0.0}, // 56
	...
	{-35.0, -131.0, 0.0},     // 57
	{- 54.0, -131.0, 0.0},    // 58
	{ -54.0, -131.0, 10.0 },  // transition
	{ -43.0, -131.0, 10.0 },  // transition
	{- 43.0, -131.0, 0.0},    // 59
	{- 35.0, -138.0, 0.0},    // 60
	{- 35.0, -144.0, 0.0},    // 61
	{- 54.0, -144.0, 0.0},    // 62
	{ -54.0, -144.0, 10.0 },  // transition
	{ -43.0, -144.0, 10.0 },  // transition
	{- 43.0, -144.0, 0.0},    // 63
	{- 35.0, -151.0, 0.0},    // 64
	{- 35.0, -157.0, 0.0},    // 65
	{- 54.0, -157.0, 0.0},    // 66
