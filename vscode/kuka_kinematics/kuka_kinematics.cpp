...
auto forward() -> void {
	double axesInput[7] = { 0., 0., 0., 0., 0., 0., 0. }; // in units of degree
...
auto inverse() -> void {
	double cartInput[7] = { 0., 0., 1266., 0., 0., 0., 0. }; // zero position
	double axesOutput[7] = { 0., 0., 0., 0., 0., 0., 0. };
	int status = 0;
	int turn = 2;
	if (!getInverse(cartInput, status, turn, axesOutput, NULL, NULL, NULL)) {
